  ...
  <div class="container">
    <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
      ...
      <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
        ...
        <li><a href="manageMovies.php" class="nav-link px-2 text-secondary">Manage Movies</a></li>
        <li><a href="managePromotions.php" class="nav-link px-2 text-secondary">Manage Promotions</a></li>
      </ul>
