...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 20, 2021 at 06:14 PM
...
CREATE TABLE `customers` (
  `id` int(11) NOT NULL,
  `userID` int(11) DEFAULT NULL,
  `accountStateID` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
ALTER TABLE `bookings`
  ...
  ADD KEY `FK__promotions` (`promotionsID`);
...
ALTER TABLE `bookings`
  ...
  ADD CONSTRAINT `FK__promotions` FOREIGN KEY (`promotionsID`) REFERENCES `promotions` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
